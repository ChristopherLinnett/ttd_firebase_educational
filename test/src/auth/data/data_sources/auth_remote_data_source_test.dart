...
void main() {
  ...
  late MockFirebaseStorage cloudStoreClient;
  ...
  setUpAll(() async {
    ...
    cloudStoreClient = MockFirebaseStorage();
  ...
  group('updateUser', () {
    ...
    test(
      ...
      () async {
        ...
        final userData =
            await dbClient.collection('users').doc(mockUser.uid).get();
    ...
    test(
      ...
      () async {
        ...
        expect(cloudStoreClient.storedFilesMap.isNotEmpty, isTrue);
      },
    );
  });
}
